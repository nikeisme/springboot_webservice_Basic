...
import com.webservice.basic.web.dto.PostsUpdateRequestsDto;
...
public class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        String expectedContent = "content2";
         ...
         PostsUpdateRequestsDto requestDto =
        ...
        List<Posts> all = postsRepository.findAll(); // 테이블 posts 에 있는 모든 데이터를 조회해오는 메소드
